...
public class scrWallRecSlantedOLD : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        offset = new Vector4(
            (gameObject.transform.position.x+gameObject.transform.localPosition.x-Camera.main.transform.position.x) % halfsize / halfsize * 0.5f -gameObject.transform.localScale.x/6,
            (gameObject.transform.position.y+gameObject.transform.localPosition.y-Camera.main.transform.position.y) % halfsize / halfsize * 0.5f -gameObject.transform.localScale.y/6,
            0,0);
        ...
        rend.material.SetFloat("_Rotate", -gameObject.transform.localEulerAngles.z+gameObject.transform.rotation.z);
